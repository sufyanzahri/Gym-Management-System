...
Partial Public Class AllPaymentsDataSet
    ...
    Partial Public Class PaymentDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddPaymentRow(ByVal Member_ID As Integer, ByVal Payment_Date As Date, ByVal Amount As Decimal, ByVal Member_Name As String) As PaymentRow
            Dim rowPaymentRow As PaymentRow = CType(Me.NewRow,PaymentRow)
            Dim columnValuesArray() As Object = New Object() {Member_ID, Payment_Date, Amount, Member_Name}
    ...
    Partial Public Class PaymentRow
        ...
        Public Property Member_Name() As String
            Get
                Try 
                    Return CType(Me(Me.tablePayment.Member_NameColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'Member_Name' in table 'Payment' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablePayment.Member_NameColumn) = value
            End Set
        End Property
        ...
        Public Function IsMember_NameNull() As Boolean
            Return Me.IsNull(Me.tablePayment.Member_NameColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub SetMember_NameNull()
            Me(Me.tablePayment.Member_NameColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace AllPaymentsDataSetTableAdapters
    ...
    Partial Public Class PaymentTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        Payment.Member_ID, Members.Member_Name, Payment.Payment_Date, Payme"& _ 
                "nt.Amount"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            (Payment INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Members"& _ 
                " ON Payment.Member_ID = Members.ID)"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER BY Payment.Member_ID, Members.Member_"& _ 
                "Name"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As AllPaymentsDataSet.PaymentDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As AllPaymentsDataSet.PaymentDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As AllPaymentsDataSet.PaymentDataTable = New AllPaymentsDataSet.PaymentDataTable()
